...
export default function Faq2() {
  return (
    <div className="faqs-wrap wrap-faqs-2">
      <div className="themesflat-container">
        <div className="row">
          <div className="col-lg-6">
            ...
            <div className="flat-accordion1">
              <Accordion faqData={faqs3} toggleClass="flat-toggle1" />
            </div>
          </div>
          <div className="col-lg-6">
            <div className="image">
              <Image
                className="img-01"
                src="/assets/images/bg-section/image-19.png"
                alt="image"
                width={521}
                height={610}
              />
